...
var Trie = /** @class */ (function () {
    ...
    function Trie(db, root) {
        this.EMPTY_TRIE_ROOT = sbr_util_1.KECCAK256_RLP;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        if (!this.root.equals(sbr_util_1.KECCAK256_RLP)) return [3 /*break*/, 5];
    ...
    Trie.prototype._formatNode = function (node, topLevel, opStack, remove) {
        ...
        if (rlpNode.length >= 32 || topLevel) {
            ...
            var hashRoot = sbr_util_1.keccak(rlpNode);
                ...
                switch (_a.label) {
                    case 0:
                        opStack = proof.map(function (nodeValue) {
                            return {
                                type: 'put',
                                key: sbr_util_1.keccak(nodeValue),
                                value: nodeValue,
                            };
                        });
                        if (!trie) {
